...
from facenet_engine_v2 import FacenetEngine
...
class TestFacenetEngine(unittest.TestCase):
    ...
    def test_predict(self):
        ...
        :return:
        """
        predictions = self.engine.predict(r"D:\face_contest\FaceRecognitionContest-main\src\Server\engine\recognition_images\1603373218.383128.jpeg")
    ...
    def test_recognize(self):
        name, user_id, department = self.engine.recognize(r"D:\face_contest\FaceRecognitionContest-main\src\Server\engine\recognition_images\1603373218.383128.jpeg")
