...
class DbController(metaclass=SingletonMetaDB):
    ...
    def __init__(self):
        ...
        print('Success connect DB lukifer')
        ...
        self.talent5__accuracy_collection = db[config_data['DB_INFO']['talent5__accuracy_collection']]
    ...
    def add_ts_to_feedback_coll(self):
        ...
        # print('added staff to feedback')
        return list(cursor)
        
    def update_current_accuracy_staff(self, data):
        """ Input: json()
            Return None
        """
        collection_name = 'talent5__accuracy_collection'
        collection = self.get_collection(collection_name)
        collection.update_one(data)
        print('Update current accuracy')
        return None
...
if __name__ == '__main__':
    ...
    # a = db_ctrl.find({"name":"tri"})
    # print("findtest : ", list(a))
    # db_ctrl.insert_feedback({"name":"tri"})
    # print('Feedback OK')
    # db_ctrl.insert_encode({"name":"tri"})
    # print('Encode ok')